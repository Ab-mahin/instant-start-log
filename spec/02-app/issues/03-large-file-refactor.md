...
1. **Spec change**: Added "Max ~200 lines per file" rule to `spec/01-app/01-project-spec.md` and conventions.
...
4. **Spec references**: `spec/01-app/01-project-spec.md` (File Structure Rules).
