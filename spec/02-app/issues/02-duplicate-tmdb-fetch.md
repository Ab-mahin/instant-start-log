...
4. **Why spec did not prevent it**: SPEC.md described each command independently without noting shared patterns.

## Fix Description

1. **Spec change**: Added DRY principle rule and shared function references to `spec/01-app/01-project-spec.md`.
...
4. **Spec references**: `spec/01-app/01-project-spec.md` (DRY Principle section).
