...
4. **Why spec did not prevent it**: Original SPEC.md documented the `"now"` value in Appendix B without flagging it as a bug. Spec described current behavior, not desired behavior.
...
4. **Spec references**: `spec/01-app/01-project-spec.md` (Known Pitfalls table), `SPEC.md` Appendix B.
