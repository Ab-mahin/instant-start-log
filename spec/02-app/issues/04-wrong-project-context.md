...
1. **Spec change**: Added explicit scope statement to `spec/01-app/01-project-spec.md`: "This is a Go CLI project only — no web frontend, no PHP, no WordPress."
...
4. **Spec references**: `spec/01-app/01-project-spec.md` (Scope section), `.lovable/memory/01-project-overview.md`.
